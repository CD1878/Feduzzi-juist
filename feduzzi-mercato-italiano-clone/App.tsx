...
const App: React.FC = () => {
  ...
  return (
    <div className="font-sans text-gray-800 bg-feduzzi-cream min-h-screen flex flex-col">
      ...
      <header className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-black/90 py-2' : 'bg-transparent py-6'} text-white`}>
        <div className="container mx-auto px-4 md:px-8 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-8 text-lg font-sans tracking-wide">
            ...
            <a href="#" className="hover:text-gray-300 transition-colors">Sfeer</a>
            <a href="#" className="hover:text-gray-300 transition-colors">Over ons</a>
            <a href="#" className="hover:text-gray-300 transition-colors">Werken bij</a>
            <div className="relative group cursor-pointer">
              <span className="hover:text-gray-300 transition-colors">Vestigingen</span>
            </div>
          </nav>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a href="#" className="bg-feduzzi-red hover:bg-red-800 text-white px-6 py-2 rounded-sm border border-transparent transition-colors text-lg">
              Bestel broodjes
            </a>
          </div>
          ...
          <div className="md:hidden flex items-center gap-4">
             <a href="#" className="bg-feduzzi-red text-white px-3 py-1 text-sm rounded-sm">Bestel</a>
      ...
      {/* Sub Navigation Bar */}
      <div className="bg-feduzzi-red py-4 md:py-6">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
            {/* Image (B&W Sandwich from source concept, but using placeholder for stability if source unavailable) */}
          ...
          <div className="flex flex-col md:flex-row items-start gap-12 lg:gap-20">
            ...
            <div className="w-full md:w-1/2 md:pt-12 space-y-6">
              ...
              <div className="space-y-4 text-gray-700 text-lg font-light leading-relaxed">
                ...
                <div className="pt-4">
                  <a href="#" className="underline decoration-1 underline-offset-4 hover:text-feduzzi-red transition-colors">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-4 text-center md:text-left">
            ...
            <div className="flex flex-col items-center md:items-start space-y-3">
              ...
              <a href="#" className="hover:text-gray-300 font-light underline decoration-1 underline-offset-4 text-sm">Maaltijden</a>
              <a href="#" className="hover:text-gray-300 font-light underline decoration-1 underline-offset-4 text-sm">Broodjes</a>
              <a href="#" className="hover:text-gray-300 font-light underline decoration-1 underline-offset-4 text-sm">Traiteur</a>
            ...
            <div className="flex flex-col items-center md:items-start space-y-3">
              ...
              <a href="#" className="hover:text-gray-300 font-light underline decoration-1 underline-offset-4 text-sm">Online broodjes</a>
              <a href="#" className="hover:text-gray-300 font-light underline decoration-1 underline-offset-4 text-sm">Catering Amsterdam</a>
              <a href="#" className="hover:text-gray-300 font-light underline decoration-1 underline-offset-4 text-sm">Catering Laren</a>
            </div>
