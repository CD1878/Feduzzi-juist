        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {SERVICES.map((service, index) => (
            <div key={index} className="flex flex-col items-center text-center group">
              ...
              <a 
                href={service.link}
                className="mt-auto px-8 py-3 border border-gray-400 text-gray-600 rounded-md hover:bg-gray-600 hover:text-white transition-all duration-300 uppercase tracking-wider text-sm"
              >
                {service.buttonText}
              </a>
            </div>
