      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <div className="font-sans text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto space-y-6 font-light">
            ...
            <p>
              Vriendelijk personeel, Italiaanse muziek en een prachtige winkels in <a href="#amsterdam" className="underline hover:text-feduzzi-red">Amsterdam</a> en <a href="#laren" className="underline hover:text-feduzzi-red">Laren</a> waar het lijkt alsof u echt in Italië bent. Wij staan voor u klaar. Wanneer zien wij u bij ons in de winkel?
            </p>
          </div>
        </div>

        {/* Collage Grid */}
        <div className="relative w-full aspect-[4/3] md:aspect-[16/9] lg:aspect-[2/1] mt-12 mb-16">
          {/* Using a custom grid for the collage effect to match screenshot */}
          <div className="grid grid-cols-12 grid-rows-6 h-full w-full gap-4">
            ...
            {/* Pasta fill in the middle to complete the busy look if needed, 
                but based on screenshot, there is a central pasta dish usually. 
                Let's assume the previous grid logic covers the main visible areas.
                The HTML actually implies a very fluid overlapping layout. 
                I'll stick to this approximated 5-image collage.
            */}
