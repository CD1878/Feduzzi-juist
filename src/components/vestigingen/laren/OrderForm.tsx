...
const OrderForm: React.FC = () => {
    ...
    return (
        <section id="order" className="bg-white py-24 px-4">
            <div className="max-w-[800px] mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-8 font-sans text-gray-800">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    type="text"
                                    required
                                    className="w-full border border-gray-400 rounded-sm p-3 focus:outline-none focus:border-feduzzi-red transition-colors bg-white"
                                />
                            </div>
                            <div>
                    ...
                    <div>
                        ...
                        <textarea
                            rows={4}
                            className="w-full border border-gray-400 rounded-sm p-3 focus:outline-none focus:border-feduzzi-red transition-colors resize-y bg-white"
                        ></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-6">
                            <label className="flex items-center space-x-2 cursor-pointer">
                                <input type="checkbox" className="w-5 h-5 border-gray-400 rounded-sm text-feduzzi-red focus:ring-feduzzi-red" />
                    ...
                    <div>
                        ...
                        <div className="relative max-w-[200px]">
                            <input
                                ...
                                className="w-full border border-gray-400 rounded-sm p-3 pr-10 focus:outline-none focus:border-feduzzi-red transition-colors appearance-none bg-white"
                            />
