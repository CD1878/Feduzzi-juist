                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="font-sans text-lg leading-relaxed text-gray-800">
                            ...
                            <a href="https://maps.app.goo.gl/YourMapLinkHere" target="_blank" rel="noopener noreferrer" className="underline mt-2 inline-block hover:text-feduzzi-red transition-colors">Route</a>
                        </div>
                    </div>
