...
const SfeerPage: React.FC = () => {
    return (
        <div className="font-sans text-gray-800 bg-feduzzi-cream min-h-screen flex flex-col">
            ...
            {/* Sub Navigation Bar - Linking to other menu sections */}
            <div className="bg-feduzzi-red py-4 md:py-6">
                <div className="container mx-auto flex justify-center gap-8 md:gap-24 text-white text-base md:text-xl font-sans tracking-wide">
                    <a href="/menu/maaltijden" className="hover:opacity-80 transition-opacity">Maaltijden</a>
                    <a href="/menu#broodjes" className="hover:opacity-80 transition-opacity">Broodjes</a>
                    <a href="/menu/traiteur" className="hover:opacity-80 transition-opacity">Traiteur</a>
                </div>
            </div>
                ...
                <div className="container mx-auto px-4 md:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        <div className="flex flex-col space-y-6">
                            ...
                            <div className="pt-2">
                                <a href="/menu/maaltijden" className="inline-block border border-feduzzi-green text-feduzzi-green px-8 py-3 rounded-sm hover:bg-feduzzi-green hover:text-white transition-colors text-sm tracking-widest uppercase">
                        ...
                        <div className="flex flex-col space-y-6">
                            ...
                            <div className="pt-2">
                                <a href="/menu#broodjes" className="inline-block border border-feduzzi-green text-feduzzi-green px-8 py-3 rounded-sm hover:bg-feduzzi-green hover:text-white transition-colors text-sm tracking-widest uppercase">
                                    Bekijk broodjes
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col space-y-6">
                            ...
                            <div className="pt-2">
                                <a href="/menu/traiteur" className="inline-block border border-feduzzi-green text-feduzzi-green px-8 py-3 rounded-sm hover:bg-feduzzi-green hover:text-white transition-colors text-sm tracking-widest uppercase">
                    ...
                    <div className="flex flex-col md:flex-row items-start gap-12 lg:gap-20">
                        ...
                        <div className="w-full md:w-1/2 md:pt-12 space-y-6">
                            ...
                            <div className="space-y-4 text-gray-700 text-lg font-light leading-relaxed">
                                ...
                                <div className="pt-4">
                                    <a href="#vestigingen" className="underline decoration-1 underline-offset-4 hover:text-feduzzi-red transition-colors">
